...
mod tests {
    ...
    fn genome(diet: f32, eff: f32) -> Genome {
        Genome::from_array([0.5, eff, 0.0, diet, 0.9, 0.5, 0.5, 0.5, 0.5, 0.5])
    }
    ...
    fn does_not_step_onto_impassable_richer_neighbor() {
        ...
        pop.spawn(TraitOrganism::new(
            Genome::from_array([0.5, 1.0, 1.0, 0.0, 0.9, 0.5, 0.5, 0.5, 0.5, 0.5]),
            start,
            5.0,
        ));
        let mut rng = Rng::new(1);
    ...
    fn swimmer(swim: f32) -> Genome {
        Genome::from_array([0.5, 1.0, 1.0, 0.0, 0.9, 0.5, 0.5, 0.5, swim, 0.5])
    }
    ...
    fn predator(size: f32) -> Genome {
        Genome::from_array([size, 1.0, 0.0, 1.0, 0.9, 0.5, 0.5, 0.5, 0.5, 0.5])
    }
    fn prey(size: f32) -> Genome {
        Genome::from_array([size, 1.0, 0.0, 0.0, 0.9, 0.5, 0.5, 0.5, 0.5, 0.5])
    }
    ...
    fn well_fed_organism_spawns_one_child() {
        ...
        let g = Genome::from_array([0.5, 1.0, 0.0, 0.0, 0.0, 0.5, 0.5, 0.5, 0.5, 0.5]);
    ...
    fn starving_organism_does_not_reproduce() {
        ...
        let g = Genome::from_array([0.5, 1.0, 0.0, 0.0, 1.0, 0.5, 0.5, 0.5, 0.5, 0.5]);
    ...
    fn tol_genome(heat_tol: f32, drought_tol: f32) -> Genome {
        Genome::from_array([0.5, 1.0, 0.0, 0.0, 0.9, 0.5, heat_tol, drought_tol, 0.5, 0.5])
    }
